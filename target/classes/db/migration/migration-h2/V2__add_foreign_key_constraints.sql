...
ALTER TABLE my_treasures ADD CONSTRAINT fk_my_treasures_user FOREIGN KEY (user_id) REFERENCES users (id);
ALTER TABLE my_treasures ADD CONSTRAINT fk_my_treasures_treasure FOREIGN KEY (treasure_id) REFERENCES treasures (id);