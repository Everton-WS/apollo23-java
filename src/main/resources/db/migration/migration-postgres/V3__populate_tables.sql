...
INSERT INTO events (id, name, website, start_date, end_date, city, state)
VALUES
  (1, 'Hackweek', 'www.devs2blu.com.br', '2023-05-01 09:00:00', '2023-10-31 17:00:00', 'Blumenau', 'Santa Catarina'),
  (2, 'Oktobertech', 'www.oktobertech.org', '2023-10-05 10:00:00', '2023-10-20 18:00:00', 'Blumenau', 'Santa Catarina');

-- Insert mock data into the users table
INSERT INTO users (id, name, email, mobile, password)
VALUES
  (1, 'user', 'user@apollo23.com', '123-456-7890', 'password1'),
  (2, 'admin', 'admin@apollo23.com', '987-654-3210', 'password2');
...
INSERT INTO activities (event_id, speaker_id, type, name, description, date, start_time, end_time, location)
VALUES
  (1, 1, 'Workshop', 'Workshop 1', 'Descrição do Workshop 1', '2023-11-01', '2023-11-01 09:00:00', '2023-11-01 11:00:00', 'Galpão da Arquitetura'),
  (1, 2, 'Aula', 'Lecture 1', 'Descrição da Lecture 1', '2023-11-02', '2023-11-02 10:00:00', '2023-11-02 12:00:00', 'Proway'),
  (2, 3, 'Painel', 'Panel 1', 'Descrição do Panel 1', '2023-12-06', '2023-12-06 11:30:00', '2023-12-06 13:30:00', 'Auditório');
...
INSERT INTO questions (event_id, activity_id, speaker_id, user_id, question_text, approved, excluded)
VALUES
...
INSERT INTO treasures (event_id, activity_id, token, score, hidden)
VALUES
  (1, 1, 'token1', 10, false),
  (1, 2, 'token2', 15, true),
  (2, 3, 'token3', 5, true);
